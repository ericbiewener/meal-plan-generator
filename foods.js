const rice = { carb: true, weight: 100 };
const polenta = { carb: true, weight: 0 };
const shrimp = { protein: true, weight: 75, sides: [rice] };
...
const combos = {
  ...
  "spicy squash salad with lentils and goat cheese": { protein: true, carb: true, veggie: true, weight: 50 },
  "easiest chicken noodle soup": { protein: true, veggie: true, carb: true, weight: 50 },
  "oven braised beef with tomato and garlic": { protein: true, carb: true, weight: 50, sides: [polenta] },
